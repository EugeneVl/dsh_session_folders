			...
			return runtimeClient.defineStore({
				...
				actions: {
					...
					collapseAll: (d, groupKeys, folderIds) => {
						...
						for (const key of groupKeys) d.collapsedGroups[key] = true;
						for (const id of folderIds) d.collapsedFolders[id] = true;
					},
					expandAll: (d, groupKeys, folderIds) => {
						for (const key of groupKeys) d.collapsedGroups[key] = false;
				...
				return [
					...
					{ id: "fork", label: t("menu.fork") },
					{
						...
						submenu: [
							...
							{ id: "move-new-folder", label: t("menu.moveNewFolder") }
						]
					},
