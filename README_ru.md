...
2. **Переименовать / удалить папку** — правый клик по строке папки; удаление требует подтверждения, сессии папки становятся свободными
...
5. **Быстрая архивация** — наведите на строку сессии: метка времени на её месте сменится иконкой архива; клик — архивация
